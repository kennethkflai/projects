...
path = r'database/tufts/TD_RGB_A_Set[1-4]/*'
typ = 'rgb_a'
face_det(path,typ)

path = r'database/tufts/TD_IR_A_Set[1-4]/*'
typ = 'ir_a'
face_det(path,typ)

path = r'database/tufts/TD_IR_E_Set[1-4]/*'
typ = 'ir_e'
face_det(path,typ)

path = r'database/tufts/TD_NIR_A_Set[1-4]/*'
typ = 'nir_a'
face_det(path,typ)

path = r'database/tufts/TD_CS_Set[1-4]/*'
typ = 'cs'
face_det(path,typ)
